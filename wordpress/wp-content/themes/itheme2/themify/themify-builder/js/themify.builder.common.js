        ...
        Lightbox: {
            ...
            bindEvents: function() {
                ...
                $body
                    ...
                    .on('click', '.themify_builder_options_tab li', self.switchTabs)
                    .on('click', '.builder_cancel_lightbox', self.cancel)
                    .on('click', '#builder_submit_row_settings', ThemifyPageBuilder.rowSaving)
                    .on('click', '#builder_submit_column_settings', ThemifyPageBuilder.columnSaving)
                    .on('click', '#builder_submit_module_settings, #builder_preview_module', ThemifyPageBuilder.moduleSave)

                    // Content actions
                    .on('change click', '.tf-option-checkbox-js', self.clickCheckBoxOption)
                    .on('click', '#tfb_module_settings input[type="text"], #tfb_module_settings textarea', self.focusInput)
                    ...
                    .on('click', '.reset-styling', self.resetStyling);
