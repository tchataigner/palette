...
(function ($, window, document, undefined) {
    ...
    ThemifyPageBuilder = {
        ...
        bindEvents: function () {
            ...
            // Import links
            $('.themify_builder_import_page').on('click', this.builderImportPage);
            $('.themify_builder_import_post').on('click', this.builderImportPost);
            $('.themify_builder_import_file').on('click', this.builderImportFile);
            $('.themify_builder_load_layout').on('click', this.builderLoadLayout);
            $('.themify_builder_save_layout').on('click', this.builderSaveLayout);
            ...
            $body.on('click', '.themify-builder-media-uploader', function (event) {
                ...
                file_frame.on('insert select', function () {
                    ...
                    var attachment = file_frame.state().get('selection').first().toJSON(),
                            ...
                            attachmentBySize = attachment.sizes[size].url;
                    ...
                    $el.closest('.themify_builder_input').find('.themify-builder-uploader-input').val(attachmentBySize).trigger('change')
                            ...
                            .html($('<img/>', {src: attachment.sizes.thumbnail.url, width: 50, height: 50}))
                            .parent().show();
                });
