    ...
    <div id="<?php echo esc_attr($module_ID); ?>" class="<?php echo esc_attr($container_class); ?>">
        ...
        <?php else : ?>
            ...
            if (!empty($address_map) || !empty($latlong_map)) {
                ...
                ?>
                <div data-map="<?php esc_attr_e(json_encode($data)) ?>" class="themify_map"  style="<?php echo esc_attr($style); ?>" class="map-container" data-info-window="<?php echo esc_attr($info_window_map); ?>" data-reverse-geocoding="<?php echo ( empty($address_map) && !empty($latlong_map) ) ? true : false; ?>"></div>
            <?php } ?>
        <?php endif; ?>
